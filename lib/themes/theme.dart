...
class CustomColors {
  ...
  static const Color mainColor = Color(0xFF005E23);
  static const Color background = Color(0xFF011922);
  ...
  static const Color secondaryColor = Color(0xFF8DF900);
  static const Color thirdColor = Color(0xFF011922);
